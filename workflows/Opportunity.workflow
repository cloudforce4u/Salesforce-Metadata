...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Alert_for_Oppty</fullName>
        <description>Alert for Oppty</description>
        ...
        <template>unfiled$public/Oppty_Template</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        ...
        <template>unfiled$public/Deal_Reg_Final_Decision_Partners</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        ...
        <senderAddress>sfdc.support@hp.com</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>unfiled$public/Partner_Submission_Template</template>
    </alerts>
    <fieldUpdates>
...
Close_Date_Push_Counter__c + 1)</formula>
    ...
    <fieldUpdates>
        <fullName>Oppty_Amount_Update</fullName>
        <field>Big_Deal_Review__c</field>
        <literalValue>1</literalValue>
        <name>Oppty Amount Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
...
PRIORVALUE(Close_Date_Delta__c) + ( CloseDate - PRIORVALUE(CloseDate )))</formula>
    ...
    <fieldUpdates>
        <fullName>Update_IsResubmission_Flag</fullName>
        <field>isResubmitted__c</field>
        <literalValue>1</literalValue>
        <name>Update IsResubmission Flag</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Update_Sales_Stage_in_Opportunity</fullName>
        <field>StageName</field>
        <literalValue>03 - Qualify the Opportunity</literalValue>
        <name>Update Sales Stage in Opportunity</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
    ...
    <outboundMessages>
        <fullName>Nitro_New_Business</fullName>
        <apiVersion>29.0</apiVersion>
        <description>Business is New</description>
        <endpointUrl>http://app.bunchball.net/n4sf/wom.php?action=Nitro_New_Business</endpointUrl>
        <fields>Id</fields>
        <fields>LastModifiedById</fields>
        <includeSessionId>true</includeSessionId>
        <integrationUser>nitroadmin@hp.com</integrationUser>
        <name>Nitro_New_Business</name>
        <protected>false</protected>
        <useDeadLetterQueue>false</useDeadLetterQueue>
    </outboundMessages>
    <outboundMessages>
        <fullName>Nitro_New_Opportunity</fullName>
        <apiVersion>29.0</apiVersion>
        <endpointUrl>http://app.bunchball.net/n4sf/wom.php?action=Nitro_New_Opportunity</endpointUrl>
        <fields>CreatedById</fields>
        <fields>Id</fields>
        <includeSessionId>true</includeSessionId>
        <integrationUser>nitroadmin@hp.com</integrationUser>
        <name>Nitro_New_Opportunity</name>
        <protected>false</protected>
        <useDeadLetterQueue>false</useDeadLetterQueue>
    </outboundMessages>
    <outboundMessages>
        <fullName>Nitro_Opportunity_Size</fullName>
        <apiVersion>29.0</apiVersion>
        <description>Opportunity is 325K or Above</description>
        <endpointUrl>http://app.bunchball.net/n4sf/wom.php?action=Nitro_Opportunity_Size</endpointUrl>
        <fields>Id</fields>
        <fields>LastModifiedById</fields>
        <includeSessionId>true</includeSessionId>
        <integrationUser>nitroadmin@hp.com</integrationUser>
        <name>Nitro_Opportunity_Size</name>
        <protected>false</protected>
        <useDeadLetterQueue>false</useDeadLetterQueue>
    </outboundMessages>
    <outboundMessages>
        <fullName>Nitro_Stage_Updated</fullName>
        <apiVersion>29.0</apiVersion>
        <description>Stage is updated</description>
        <endpointUrl>http://app.bunchball.net/n4sf/wom.php?action=Nitro_Stage_Updated</endpointUrl>
        <fields>Id</fields>
        <fields>LastModifiedById</fields>
        <includeSessionId>true</includeSessionId>
        <integrationUser>nitroadmin@hp.com</integrationUser>
        <name>Nitro_Stage_Updated</name>
        <protected>false</protected>
        <useDeadLetterQueue>false</useDeadLetterQueue>
    </outboundMessages>
    <outboundMessages>
        <fullName>Nitro_Task_Status_Complete</fullName>
        <apiVersion>29.0</apiVersion>
        <description>Specified fields are filled (sales hygiene)</description>
        <endpointUrl>http://app.bunchball.net/n4sf/wom.php?action=Nitro_Task_Status_Complete</endpointUrl>
        <fields>Id</fields>
        <fields>LastModifiedById</fields>
        <includeSessionId>true</includeSessionId>
        <integrationUser>nitroadmin@hp.com</integrationUser>
        <name>Nitro_Task_Status_Complete</name>
        <protected>false</protected>
        <useDeadLetterQueue>false</useDeadLetterQueue>
    </outboundMessages>
    <rules>
    ...
    <rules>
        <fullName>DealReg Update Oppty Resubmiited Flag</fullName>
        <actions>
            <name>Update_IsResubmission_Flag</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
            <field>Opportunity.Deal_Registration_Status__c</field>
            <operation>equals</operation>
            <value>Approved,Rejected,Partially Approved</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <description>Create a new opportunity</description>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Opportunity.Opportunity_Sales_Stage__c</field>
            <operation>greaterThan</operation>
            <value>01</value>
        </criteriaItems>
        <criteriaItems>
    ...
    <rules>
        <fullName>Opportunity - Update Sales stage when Deal Reg status Change</fullName>
        <actions>
            <name>Update_Sales_Stage_in_Opportunity</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <criteriaItems>
            <field>Opportunity.OpportunityOwnerType__c</field>
            <operation>equals</operation>
        ...
        <criteriaItems>
            ...
            <operation>notEqual</operation>
            <value>04A - Develop Solution,04B - Propose Solution,05 - Negotiate &amp; Close,&quot;06 - Won, Deploy &amp; Expand&quot;,Lost,HP Not Pursued,Error</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Oppty Amount is 10k</fullName>
        <actions>
            <name>Alert_for_Oppty</name>
            <type>Alert</type>
        </actions>
        <actions>
            <name>Oppty_Amount_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
